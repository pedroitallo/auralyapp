...
export const affirmations = [
  ...
  "I am worthy of love, prosperity, and happiness.",
  "My potential to succeed is infinite.",
  "I attract abundance and success into my life.",
  "My heart is open to giving and receiving love.",
  "I trust my intuition and I am always guided to make the right decisions.",
  "Every day, I am becoming a better version of myself.",
  "I am the architect of my life; I build its foundation and choose its contents.",
  "I am grateful for all that I have and all that is yet to come.",
  "I release all that no longer serves me and welcome positive energy.",
  "My relationships are a source of joy and strength.",
  "I am financially abundant, and money flows to me easily.",
  "I am confident, powerful, and capable of achieving my goals.",
  "I choose to see challenges as opportunities for growth.",
  "My mind is filled with positive thoughts and my life is filled with positive outcomes.",
  "I am at peace with my past and excited for my future.",
  "I am surrounded by supportive and loving people.",
  "My body is a temple; I nourish it with healthy food and positive thoughts.",
  "I am creating a life that I love.",
  "I have the power to create change and make a difference in the world."
];
