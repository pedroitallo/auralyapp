...
import { Shield, AlertTriangle, Loader, LayoutDashboard, Bell, Users, MousePointer } from 'lucide-react';
        ...
        <Tabs defaultValue="analytics" className="w-full">
          <div className="flex justify-center">
            <TabsList className="bg-zinc-200 p-1.5 rounded-xl">
              ...
              <TabsTrigger value="tracker" className="px-4 py-2 flex items-center gap-2 data-[state=active]:bg-white data-[state=active]:shadow-md"><MousePointer className="w-4 h-4" /> Tracker</TabsTrigger>
            </TabsList>
          </div>
